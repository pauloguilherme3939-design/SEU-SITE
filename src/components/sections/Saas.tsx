...
export default function Saas() {
  const waUrl = buildWhatsAppUrl(
    'Olá! Vi a seção de sistemas no Site no Ar Express e tenho uma ideia que quero tirar do papel. Pode me dar mais informações sobre como funciona e o que custa?',
  );
        ...
        <div className="animate-fade-up relative overflow-hidden rounded-[var(--radius-lg)] border border-line-hi" style={{ animationDelay: '60ms' }}>
          ...
          <div className="relative grid grid-cols-1 gap-0 lg:grid-cols-2">
            ...
            <div className="p-8 sm:p-12 lg:border-r lg:border-line">
              ...
              >
                Você tem uma ideia de SaaS, MicroSaaS, sistema interno ou ferramenta online?
              </h2>

              <p className="mt-5 leading-relaxed text-muted">
                Além de sites e landing pages, também desenvolvo{' '}
                <strong className="font-semibold text-ink">soluções digitais sob medida: painéis, sistemas simples, áreas de cadastro, automações, integrações com WhatsApp</strong>{' '}
                e ferramentas para transformar uma ideia em produto real.
              </p>
