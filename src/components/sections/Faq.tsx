  ...
  return (
    <Section anchorId="duvidas" className="bg-bg">
      <Container size="md">
        ...
        {/* Bottom CTA */}
        <div
          className="animate-fade-in mt-12 rounded-[var(--radius)] border border-line bg-card-hi px-6 py-6 text-center sm:px-10"
        ...
        >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 rounded-full bg-whats px-6 py-3 text-sm font-semibold text-white shadow-[0_8px_24px_-8px_rgba(37,211,102,0.5)] transition-all hover:brightness-110"
          >
