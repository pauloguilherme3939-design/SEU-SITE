...
const RESULTS: Record<ResultKey, {
  ...
  inicial: {
    ...
    waMessage:   'Olá! Fiz o quiz no Site no Ar Express e o plano recomendado foi Presença Inicial (R$ 497). Quero saber o que está incluso e verificar se ainda tem vaga disponível.',
    accentColor: '#cbd5e1',
  ...
  presenca: {
    ...
    waMessage:   'Olá! Fiz o quiz no Site no Ar Express e o plano recomendado foi Presença Rápida (R$ 997). Quero criar um site completo e bonito para o meu negócio. Como funciona?',
    accentColor: '#fcd34d',
  ...
  express: {
    ...
    waMessage:   'Olá! Fiz o quiz no Site no Ar Express e o plano recomendado foi Profissional Express (R$ 1.497). Quero um site completo com SEO e Google. Ainda tem vaga disponível?',
    accentColor: '#7dd3fc',
  ...
  saas: {
    ...
    waMessage:   'Olá! Fiz o quiz no Site no Ar Express e tenho uma ideia de sistema ou ferramenta digital. Quero conversar sobre o desenvolvimento. Pode me ajudar?',
    accentColor: '#e8c87a',
