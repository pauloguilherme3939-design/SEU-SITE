...
const RESULTS: Record<ResultKey, {
  ...
  inicial: {
    ...
    waMessage:   'Olá! Fiz o quiz e o plano indicado foi Presença Inicial de R$497. Quero entender se ele serve para meu negócio.',
    accentColor: '#cbd5e1',
  ...
  presenca: {
    ...
    waMessage:   'Olá! Fiz o quiz e o plano indicado foi Presença Rápida de R$997. Quero conversar sobre meu site.',
    accentColor: '#fcd34d',
  ...
  express: {
    ...
    waMessage:   'Olá! Fiz o quiz e o plano indicado foi Profissional Express de R$1.497. Quero criar meu site com domínio, WhatsApp e Google.',
    accentColor: '#7dd3fc',
  ...
  empresarial: {
    ...
    waMessage:   'Olá! Fiz o quiz e o plano indicado foi Empresarial Completo de R$2.997. Quero conversar sobre um site mais completo.',
    accentColor: '#c4b5fd',
  ...
  saas: {
    ...
    waMessage:   'Olá! Fiz o quiz e quero conversar sobre uma solução sob medida, sistema ou MicroSaaS.',
    accentColor: '#e8c87a',
